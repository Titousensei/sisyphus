...
public class InnerJoin
{
  public static void main(String[] args)
  {
    ...
    Input in_join = new InputJoinSorted(join_schema, sorted1, sorted2, sorted3);

    Output out_join = new OutputFile(RESULTS_DIR+"out.join.gz",
        OutputFile.Flag.REPLACE, "id", "a1", "a2", "a3");
