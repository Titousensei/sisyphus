...
extends Modifier
{
  ...
  { this(map, map.getSchemaIn().get(0), map.getSchemaIn().get(1)); };

  /**
   * Use these constructors only if the query schema doesn't match the KeyMap schema.
  ...
  public KeyMapGetter(KeyMap map, String col_value)
  { this(map, map.getSchemaIn().get(0), col_value); }
